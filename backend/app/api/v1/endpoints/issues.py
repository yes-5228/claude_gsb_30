...
def list_issues(
    ...
    include_voided: Annotated[bool, Query(description="包含已随评价作废的问题")] = False,
    voided_only: Annotated[bool, Query(description="仅看已随评价作废的问题")] = False,
